...
class LotteryTest {
    ...
    private final Lotto lotto1 = new Lotto(Arrays.asList(one, two, three, four, five, six));
    private final Lotto lotto2 = new Lotto(Arrays.asList(one, two, three, four, five, seven));
    private final Lotto lotto3 = new Lotto(Arrays.asList(one, two, three, four, seven, eight));
    private final Lotto lotto4 = new Lotto(Arrays.asList(one, two, three, seven, eight, nine));
    private final Lotto lotto5 = new Lotto(Arrays.asList(one, two, seven, eight, nine, ten));
    private final Lotto lotto6 = new Lotto(Arrays.asList(one, seven, eight, nine, ten, eleven));
    ...
    void canDrawLotteryWithWinningNumbers() {
        ...
        // when
        final List<Integer> result = lottery.drawLotteryWithWinningNumbers(winningNumbers);
    ...
    void canDrawLotteryWithBonusNumber() {
        ...
        // when
        final List<Integer> result = lottery.drawLotteryWithBonusNumber(bonusNumber);
